  ...
  return (
    <section className="rounded-2xl bg-white shadow-sm border border-gray-100 overflow-hidden p-6 md:p-8">
      <form action={formAction} className="space-y-6">
        ...
        {/* Apartment assignment — visible only for SUPERVISOR and OWNER */}
        {needsApartments && (
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-400">
              {selectedRole === "SUPERVISOR"
                ? "Il supervisore vedrà solo le revisioni di questi appartamenti."
        ...
        <div className="pt-4 flex items-center justify-end gap-3 mt-8">
          ...
          >
            {isPending ? t.usrCreating : t.usrCreateUser}
          </button>
        </div>
