...
import { delegateFunction, revokeFunction, updateEngagementApartments, removeCompanyFromOrg } from "@/src/app/actions/company";
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm space-y-3">
        ...
        {companies.length === 0 ? (
          <p className="text-xs text-gray-400">Nessuna impresa disponibile. Le imprese vengono create dall&apos;amministratore della piattaforma.</p>
        ) : (
