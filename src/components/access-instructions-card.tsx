    ...
    <>
      ...
      >
        ...
        <div className="min-w-0">
          <p className="text-[9px] font-black text-violet-600 uppercase tracking-widest mb-1">{t.moAccessInstructions}</p>
          {accessCode && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm">
          <div className="w-full max-w-xl overflow-hidden rounded-[2rem] border border-white/60 bg-white shadow-2xl shadow-black/20">
            <div className="flex items-center justify-between gap-4 border-b border-slate-100 px-6 py-5">
              <h2 className="text-sm font-black uppercase tracking-widest text-slate-900">{t.moAccessInstructions}</h2>
              <button
                type="button"
                ...
                aria-label={t.moAccessInstructions}
              >
                <X size={16} />
              </button>
            </div>
