...
export function ManagerAIChatLauncher({ apartmentId, apartmentName }: ManagerAIChatLauncherProps = {}) {
  ...
  return (
    <>
      <button
        ...
        className="mt-5 flex w-full max-w-sm items-center justify-center gap-2 rounded-2xl border border-violet-100 bg-white/70 px-5 py-3 text-xs font-bold uppercase tracking-widest text-violet-700 shadow-sm shadow-violet-500/5 transition hover:-translate-y-0.5 hover:bg-violet-50 hover:shadow-md"
      >
